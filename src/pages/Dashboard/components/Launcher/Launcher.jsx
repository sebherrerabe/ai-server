            ...
            {canDisplay ? <div className="component-container">
                <div className="display-input">
                    <form className="launcher-form" onSubmit={(e) => sendTrainingToServer(e)}>
                        ...
                        <input name="img-slug" value={inputValues.imgSlug} className={"launcher-input " + themeColors.colorPrimary} type="text" placeholder="DockerHub_username/image_name" onChange={(e) => setInputValues({ ...inputValues, imgSlug: e.target.value })} />
                        <label htmlFor="output" className="mg-bt-5"><FontAwesomeIcon icon={faRightFromBracket} />Volume</label>
                        <input name="output" value={inputValues.output} className={"launcher-input " + themeColors.colorPrimary} type="text" placeholder="/output" onChange={(e) => setInputValues({ ...inputValues, output: e.target.value })} />
                        <br />
